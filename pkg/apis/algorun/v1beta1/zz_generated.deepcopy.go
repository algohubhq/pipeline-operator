...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProbeModel) DeepCopyInto(out *ProbeModel) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProbeModel.
func (in *ProbeModel) DeepCopy() *ProbeModel {
	if in == nil {
		return nil
	}
	out := new(ProbeModel)
