...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlgoSpec) DeepCopyInto(out *AlgoSpec) {
	*out = *in
	if in.Image != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlgoSpec.
func (in *AlgoSpec) DeepCopy() *AlgoSpec {
	if in == nil {
		return nil
	}
	out := new(AlgoSpec)
...
func (in *PipelineDeploymentSpecV1beta1) DeepCopyInto(out *PipelineDeploymentSpecV1beta1) {
	*out = *in
	...
	if in.DataConnectors != nil {
		...
		*out = make([]DataConnectorSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
