...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HookRunnerConfig) DeepCopyInto(out *HookRunnerConfig) {
	*out = *in
	if in.WebHooks != nil {
		in, out := &in.WebHooks, &out.WebHooks
		*out = make([]WebHookModel, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HookRunnerConfig.
func (in *HookRunnerConfig) DeepCopy() *HookRunnerConfig {
	if in == nil {
		return nil
	}
	out := new(HookRunnerConfig)
	in.DeepCopyInto(out)
	return out
}
