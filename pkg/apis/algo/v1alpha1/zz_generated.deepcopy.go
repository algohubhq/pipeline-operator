...
func (in *EndpointConfig) DeepCopyInto(out *EndpointConfig) {
	*out = *in
	if in.Outputs != nil {
		in, out := &in.Outputs, &out.Outputs
		*out = make([]EndpointOutputModel, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EndpointOutputModel) DeepCopyInto(out *EndpointOutputModel) {
	*out = *in
	if in.MediaType != nil {
		in, out := &in.MediaType, &out.MediaType
		*out = new(MediaTypeModel)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EndpointOutputModel.
func (in *EndpointOutputModel) DeepCopy() *EndpointOutputModel {
	if in == nil {
		return nil
	}
	out := new(EndpointOutputModel)
	in.DeepCopyInto(out)
	return out
}
